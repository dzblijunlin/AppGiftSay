...
public class CateFootStyleAdapter extends BaseAdapter{
    private List<CateFootBean.DataBean.ChannelGroupsBean> data;
    private Context context;

    public CateFootStyleAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Picasso.with(context).load(data.get(1).getChannels().get(i).getCover_image_url()).into(holder.iv);
